...
class SGBaseTERenderer extends BaseTileEntityRenderer {
    ...
    public void render(TileEntity te, double x, double y, double z, float partialTicks, int destroyStage, float alpha) {
        ...
        if (gate.isMerged) {
            glPushMatrix();
            if (SGConfiguration.transparency) {
                glEnable(GL_BLEND);
    ...
    void renderStargate(SGBaseTE gate, float partialTicks) {
        ...
        bindTexture(SGCraft.getInstance().resourceLocation("textures/tileentity/stargate.png"));
        glNormal3f(0, 1, 0);
    ...
    void renderEventHorizon(SGBaseTE te, float partialTicks) {
        if (SGCraft.useHDEventHorizionTexture) {
            bindTexture(SGCraft.getInstance().resourceLocation("textures/tileentity/eventhorizonhd.png"));
        } else {
            bindTexture(SGCraft.getInstance().resourceLocation("textures/tileentity/eventhorizon.png"));
        }
    ...
    void renderIris(SGBaseTE te, double t) {
        bindTexture(SGCraft.getInstance().resourceLocation("textures/tileentity/iris.png"));
